...
public class CollectionGlobalInfoComparisonImplAdditional implements CollectionChannelsDoubleInfo {
    ...
    public void add(ChannelData channel1, ChannelData channel2) {
        ...
        globalInfoList.add(new DoubleData("Comments count",
                Long.toString(channel1.getCommentCount()),
                Long.toString(channel2.getCommentCount())));
    }
